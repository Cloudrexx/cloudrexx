 ...
 */
class JsonDataSource extends \Cx\Core\DataSource\Model\Entity\JsonDataSource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'identifier', 'type', 'options', 'dataAccesses', 'supportedOperations', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat', 'stringRepresentationBlank');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JsonDataSource $proxy) {
