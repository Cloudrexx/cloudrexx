 ...
 */
class RelCustomerCoupon extends \Cx\Modules\Shop\Model\Entity\RelCustomerCoupon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'customerId', 'orderId', 'count', 'amount', 'order', 'customer', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelCustomerCoupon $proxy) {
