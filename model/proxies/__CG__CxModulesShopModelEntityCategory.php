 ...
 */
class Category extends \Cx\Modules\Shop\Model\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function addPricelist(\Cx\Modules\Shop\Model\Entity\Pricelist $pricelist)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPricelist', array($pricelist));
    ...
    public function removePricelist(\Cx\Modules\Shop\Model\Entity\Pricelist $pricelist)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePricelist', array($pricelist));
