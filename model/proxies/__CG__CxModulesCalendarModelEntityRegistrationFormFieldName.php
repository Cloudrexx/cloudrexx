 ...
 */
class RegistrationFormFieldName extends \Cx\Modules\Calendar\Model\Entity\RegistrationFormFieldName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationFormFieldName $proxy) {
