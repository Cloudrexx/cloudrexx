...
class RegistrationFormField extends \Cx\Modules\Calendar\Model\Entity\RegistrationFormField implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'required', 'order', 'affiliation', 'registrationFormFieldNames', 'registrationFormFieldValues', 'registrationForm', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
