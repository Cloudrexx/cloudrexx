 ...
 */
class UserAttributeName extends \Cx\Core\User\Model\Entity\UserAttributeName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserAttributeName $proxy) {
