...
namespace Cx\Model\Proxies\__CG__\Cx\Modules\Jobs\Model\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Flag extends \Cx\Modules\Jobs\Model\Entity\Flag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'icon', 'value', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Flag $proxy) {
