 ...
 */
class OrderAttributes extends \Cx\Modules\Shop\Model\Entity\OrderAttributes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderAttributes $proxy) {
    ...
    public function setOrderItems(\Cx\Modules\Shop\Model\Entity\OrderItems $orderItems = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrderItems', array($orderItems));
