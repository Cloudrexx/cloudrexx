 ...
 */
class Shipper extends \Cx\Modules\Shop\Model\Entity\Shipper implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Shipper $proxy) {
    ...
    public function getShipmentCosts()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShipmentCosts', array());

        return parent::getShipmentCosts();
    }
