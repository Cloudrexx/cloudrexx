 ...
 */
class RelProductAttribute extends \Cx\Modules\Shop\Model\Entity\RelProductAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'productId', 'optionId', 'ord', 'product', 'option', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelProductAttribute $proxy) {
