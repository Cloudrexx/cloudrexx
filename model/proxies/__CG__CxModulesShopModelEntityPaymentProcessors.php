 ...
 */
class PaymentProcessors extends \Cx\Modules\Shop\Model\Entity\PaymentProcessors implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaymentProcessors $proxy) {
