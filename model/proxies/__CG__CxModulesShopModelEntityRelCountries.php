 ...
 */
class RelCountries extends \Cx\Modules\Shop\Model\Entity\RelCountries implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'zoneId', 'countryId', 'zones', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelCountries $proxy) {
    ...
    public function setZoneId($zoneId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setZoneId', array($zoneId));
    ...
    public function setZones(\Cx\Modules\Shop\Model\Entity\Zones $zones = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setZones', array($zones));

        return parent::setZones($zones);
    }
