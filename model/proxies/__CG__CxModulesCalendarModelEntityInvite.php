...
class Invite extends \Cx\Modules\Calendar\Model\Entity\Invite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'timestamp', 'inviteeType', 'inviteeId', 'email', 'token', 'registration', 'event', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
