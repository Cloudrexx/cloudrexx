...
namespace Cx\Model\Proxies\__CG__\Cx\Modules\Crm\Model\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Currency extends \Cx\Modules\Crm\Model\Entity\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cx\\Modules\\Crm\\Model\\Entity\\Currency' . "\0" . 'id', '' . "\0" . 'Cx\\Modules\\Crm\\Model\\Entity\\Currency' . "\0" . 'name', '' . "\0" . 'Cx\\Modules\\Crm\\Model\\Entity\\Currency' . "\0" . 'active', '' . "\0" . 'Cx\\Modules\\Crm\\Model\\Entity\\Currency' . "\0" . 'pos', '' . "\0" . 'Cx\\Modules\\Crm\\Model\\Entity\\Currency' . "\0" . 'hourly_rate', '' . "\0" . 'Cx\\Modules\\Crm\\Model\\Entity\\Currency' . "\0" . 'default_currency', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat', 'stringRepresentationBlank');
        }
