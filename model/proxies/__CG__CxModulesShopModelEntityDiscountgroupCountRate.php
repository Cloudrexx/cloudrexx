 ...
 */
class DiscountgroupCountRate extends \Cx\Modules\Shop\Model\Entity\DiscountgroupCountRate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'groupId', 'count', 'rate', 'discountgroupCountName', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DiscountgroupCountRate $proxy) {
