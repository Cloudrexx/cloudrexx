...
class RewriteRule extends \Cx\Core\Routing\Model\Entity\RewriteRule implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'regularExpression', 'orderNo', 'rewriteStatusCode', 'continueOnMatch', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat', 'stringRepresentationBlank');
        }
