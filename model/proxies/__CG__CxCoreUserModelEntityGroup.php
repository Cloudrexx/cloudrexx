...
class Group extends \Cx\Core\User\Model\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'id', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'name', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'description', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'active', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'type', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'homepage', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'users', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'accessId2', '' . "\0" . 'Cx\\Core\\User\\Model\\Entity\\Group' . "\0" . 'accessId', 'toolbar', 'validators', 'virtual');
        }
