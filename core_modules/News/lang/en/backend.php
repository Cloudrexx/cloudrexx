...
$_ARRAYLANG['TXT_CREATE_NEWS'] = "Add";
...
$_ARRAYLANG['TXT_NEWS_NEW_WINDOW'] = "New window";
$_ARRAYLANG['TXT_NEWS_NEW_WINDOW_HELP'] = "With this option you can choose if you want to open the news message in a different window.";
...
$_ARRAYLANG['TXT_NEWS_NEW_CATEGORY'] = "New category";
...
$_ARRAYLANG['TXT_NEWS_CATEGORY_NOT_DELETED_BECAUSE_OF_ENTRIES'] = "The category could not be deleted because it contains news messages. Delete all news messages or move them to another category first, so you will be able to delete this category.";
$_ARRAYLANG['TXT_NEWS_CATEGORY_NOT_DELETED_BECAUSE_OF_SUBCATEGORIES'] = "The category could not be deleted because it contains sub-categories.";
...
$_ARRAYLANG['TXT_USE_TEASERS'] = "Use news container";
...
$_ARRAYLANG['TXT_AVAILABLE_BOXES'] = "Available news containers";
$_ARRAYLANG['TXT_ASSOCIATED_BOXES'] = "Associated news containers";
...
$_ARRAYLANG['TXT_BOX_TEMPLATE'] = "Container template";
$_ARRAYLANG['TXT_FUNCTIONS'] = "Functions";
$_ARRAYLANG['TXT_SHOW_TEASER_BOX'] = "Show news container";
$_ARRAYLANG['TXT_EDIT_TEASER_BOX'] = "Edit news container";
$_ARRAYLANG['TXT_EDIT_BOX_TEMPLATE'] = "Edit container template";
$_ARRAYLANG['TXT_DELETE_TEASER_BOX'] = "Delete news container";
$_ARRAYLANG['TXT_ADD_BOX'] = "Add New Container";
$_ARRAYLANG['TXT_CONFIRM_DELETE_TEASER_BOX'] = "Are you sure to delete this news container?";
$_ARRAYLANG['TXT_TEASER_BOX_TEMPLATES'] = "News container templates";
$_ARRAYLANG['TXT_ADD_TEASER_BOX'] = "Add news container";
...
$_ARRAYLANG['TXT_HEADLINE_PLACEHOLLDERS_USAGE'] = "In the design Template <b>headlines.html</b>. This placeholder [[HEADLINES_FILE]] may be placed either in the design template or in the content of this page.";
...
$_ARRAYLANG['TXT_NEWS_MESSAGE_TYPE'] = "Message type";
...
$_ARRAYLANG['TXT_NEWS_AUTHOR_DESCRIPTION'] = "Author's first and last name";
...
$_ARRAYLANG['TXT_NEWS_AUTHOR_SELECTION'] = "Author selection";
$_ARRAYLANG['TXT_NEWS_PUBLISHER_SELECTION'] = "Publisher selection";
$_ARRAYLANG['TXT_NEWS_LIST_ALL'] = "List all available user accounts";
...
$_ARRAYLANG['TXT_SCHEDULED_PUBLICATION'] = "Scheduled publication";
...
$_ARRAYLANG['TXT_NEWS_NUMBER_OF_COMMENTS'] = "Number of comments";
$_ARRAYLANG['TXT_NEWS_RECENT_MESSAGES_LIMIT'] = "Amount of recent comments to show ";
$_ARRAYLANG['TXT_NEWS_SETTINGS_RECENT_MESSAGES_LIMIT_HELP'] = "Set the amount of recent comments to list in the design template block [[NEWS_RECENT_COMMENTS_FILE]]";
...
$_ARRAYLANG['TXT_NEWS_ARCHIVE_LIST'] = "Archive list";
$_ARRAYLANG['TXT_NEWS_ARCHIVE_LIST_PLACEHOLDERS_USAGE'] = "News archive can be displayed by using the placeholder <strong>[[NEWS_ARCHIVES]]</strong>. <br /> The placeholder can be used in the design template or in a content page. <br /> This will list the nested ul/li-list of Archive list as links.";
$_ARRAYLANG['TXT_NEWS_RECENT_COMMENTS'] = "Recent comments";
$_ARRAYLANG['TXT_NEWS_RECENT_COMMENTS_PLACEHOLDERS_USAGE'] = "Recent news can be integrated by using the placeholder [[NEWS_RECENT_COMMENTS_FILE]]. <br />It needs the <strong>news_recent_comments.html</strong> in design template.";
$_ARRAYLANG['TXT_NEWS_COMMENTS_CSS_DESCRIPTION'] = "Row style (row1 or row2)";
$_ARRAYLANG['TXT_NEWS_COMMENTS_TITLE_DESCRIPTION'] = "Comment title text";
$_ARRAYLANG['TXT_NEWS_COMMENTS_MESSAGE_DESCRIPTION'] = "Comment message";
$_ARRAYLANG['TXT_NEWS_COMMENTS_LONG_DATE_DESCRIPTION'] = "Comment added date with time";
$_ARRAYLANG['TXT_NEWS_COMMENTS_DATE_DESCRIPTION'] = "Comment added date";
