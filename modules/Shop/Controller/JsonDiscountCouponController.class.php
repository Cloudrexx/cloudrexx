    ...
    implements \Cx\Core\Json\JsonAdapter
{
    ...
    /**
     * Return text to be displayed in the table for the subjectToVat property
     * @param   array   $params     The callback parameters
     * @return  string
     */
    public function getSubjectToVat($params)
    {
        global $_ARRAYLANG;
    ...
    /**
     * Return a checkbox for the subjectToVat form field
     * @param   array   $params     The callback parameters
     * @return  string
     */
    public function getSubjectToVatCheckbox($params)
    {
        $wrapper = new \Cx\Core\Html\Model\Entity\HtmlElement('div');
